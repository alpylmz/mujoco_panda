...
ctrl_config = {
    ...
    'control_rate': COMMAND_PER_SECOND
}
...
if __name__ == "__main__":
    ...
    # NEED TO DO HOLD A LOCK FOR THIS
    # Zeynep, you will stuff these lists
    # The trajectory's time will be defined by COMMAND_PER_SECOND. Otherwise it is kinda hard. I think we can handle it.
    trajectories = np.vstack([target_traj_1, target_traj_2, target_traj_3])
    orientations = [target_ori] * len(trajectories)
